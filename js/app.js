//qwery is een selector engine. Werkt ook met multi-selects (div, p) en css3 atribute selectors.
...
(function () { // anonieme functie
	...
	APP.directives = {
				...
				date:
					{
						text: function(params){
							//start_time is de datum
							var date = new Date(this.start_time);
							//Maak een array met dagen
							var day_names = new Array("Zondag", "Maandag", "Dinsdag", "Woensdag", "Donderdag", "Vrijdag", "Zaterdag");
							//vraag de dag op uit date. Wordt teruggegeven in een integer 0 is zondag 6 is zaterdag
    ...
    APP.loader = {
    	start: function() {
    		//zoek element met id loader en verwijder de class noloader
